...
from mapclientplugins.transformpointcloudstep.configuredialog import ConfigureDialog


class TransformPointCloudStep(WorkflowStepMountPoint):
    '''
    ...
    def execute(self):
        ...
        self._portData2 = self._portData0
        self._doneExecution()
